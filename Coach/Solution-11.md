# Desafio 11 - Gestão de Pacotes - Guia do Coach

[<Solução anterior](./Solution-10.md) - **[Home](./README.md)** - [Próxima solução >](./Solution-12.md)
...
2. Atualize os pacotes instalados em sua máquina virtual
...
5. Mostrar detalhes do pacote para vim
...
6. Pesquise por docker na lista de pacotes e instale o Linux container runtime
